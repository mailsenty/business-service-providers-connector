...
public class CategoriesMessageProcessorDebuggable
    extends CategoriesMessageProcessor
    implements DebugInfoProvider
{


    public CategoriesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("categories", "Categories", (java.lang.String.class), categories, muleEvent));
