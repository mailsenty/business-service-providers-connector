...
public class Ita_officesMessageProcessorDebuggable
    extends Ita_officesMessageProcessor
    implements DebugInfoProvider
{


    public Ita_officesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("ita_offices", "Ita_offices", (java.lang.String.class), ita_offices, muleEvent));
